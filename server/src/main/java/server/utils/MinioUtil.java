...
import server.config.MinIO.MinioProperties;
...
public class MinioUtil {
    ...
    @ApiOperation("上传文件")
    public UploadResponseAO uploadFile(MultipartFile file, String bucketName) throws Exception {
        //判断文件是否为空
...
//        }
        ...
        return new UploadResponseAO(url, urlHost);
    }
